...
class Constants:
    ...
    SPRITE_PLAYER_SHIP_CHARGE_ORANGE = image.load(ROOT_PATH + "\\assets\\images\\ships\\SHIP_CHARGE_ORANGE")
    SPRITE_PLAYER_SHIP_CHARGE_GREEN = image.load(ROOT_PATH + "\\assets\\images\\ships\\SHIP_CHARGE_GREEN")
    SPRITE_PLAYER_SHIP_CHARGE_RED = image.load(ROOT_PATH + "\\assets\\images\\ships\\SHIP_CHARGE_RED")
