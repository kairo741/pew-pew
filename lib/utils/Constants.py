...
class Constants:
    ...
    SPRITE_POWER_UP_1 = image.load(ROOT_PATH + "\\assets\\images\\power_ups\\atk_disk.png")
    ...
    SPRITE_POWER_UP_8 = image.load(ROOT_PATH + "\\assets\\images\\power_ups\\random_disk.png")
