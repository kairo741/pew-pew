...
class Presets:
    ...
    PLAYER_BAT_WEAPON = Weapon(
        shoot_delay=120,
        weapon_type="wiggle",
        bullet=Bullet(speed=Axis(0, -20), sprite=Utils.scale_image(Constants.SPRITE_BULLET_PURPLE, 0.2), damage=26)
    )
    ...
    PLAYER_HEALTHS = [PLAYER_DEFAULT_HEALTH, PLAYER_DEFAULT_HEALTH, PLAYER_LIGHT_HEALTH, PLAYER_HEAVY_HEALTH, PLAYER_DEFAULT_HEALTH]
